  ...
  return (
   <>
    <div className="max-w-5xl mx-auto px-4 py-10 ">
            ...
            <div className='text-center font-semibold mb-4'>Drop us line!</div>
            <form class="max-w-xl mx-auto">
                ...
                <div>
                    <textarea type="text" placeholder='Message' class=" w-full p-2 h-40 border border-gray-300 rounded-lg "></textarea>
                </div>
